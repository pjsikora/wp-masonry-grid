 ...
 */
if ( !function_exists('masonry_grid_category_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function masonry_grid_category_widgets(){
        // Recent Post widget.
        register_widget('Masonry_Grid_Sidebar_Category_Widget');
    }
endif;
add_action('widgets_init', 'masonry_grid_category_widgets');
// Recent Post widget
if ( !class_exists('Masonry_Grid_Sidebar_Category_Widget') ) :
    /**
     * Recent Post.
     *
     * @since 1.0.0
     */
    class Masonry_Grid_Sidebar_Category_Widget extends Masonry_Grid_Widget_Base
    {
        /**
        ...
        {
            $opts = array(
                'classname' => 'masonry_grid_category_widget',
                'description' => esc_html__('Displays categories and posts.', 'masonry-grid'),
            ...
            $fields = array(
                ...
                'top_category' => array(
                    'label' => esc_html__('Top Categories:', 'masonry-grid'),
                    'type' => 'number',
                    'default' => 5,
                    'css' => 'max-width:60px;',
                    'min' => 1,
                ...
                'enable_cat_desc' => array(
                    'label' => esc_html__('Enable Category Description:', 'masonry-grid'),
                    'type' => 'checkbox',
                    'default' => true,
                ),
                'latest_label' => array(
                    'label'         => esc_html__('Latest Label', 'masonry-grid'),
                    'type'          => 'text',
                    'default'          => esc_html__('Latest:', 'masonry-grid'),
                ),
            );
            parent::__construct('masonry-grid-category-layout', esc_html__('MP: Category Widget', 'masonry-grid'), $opts, array(), $fields);
        }
        /**
