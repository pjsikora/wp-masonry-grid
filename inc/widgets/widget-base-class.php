 ...
 * @since 1.0.0
 */
class Masonry_Grid_Widget_Base extends WP_Widget {
	/**
	 * Fields.
	 *
	 * @since 1.0.0
		...
		switch ( $field_type ) {
			...
			case 'image':
				...
				<div>
					...
					<!-- <br /> -->
					<input type="button" class="select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'masonry-grid' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'masonry-grid' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'masonry-grid' ); ?>" />
					<?php
					$image_status = false;
					if ( ! empty( $value ) ) {
						$image_status = true;
					...
					?>
					<input type="button" value="<?php echo esc_attr_x( 'X', 'Remove', 'masonry-grid' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
