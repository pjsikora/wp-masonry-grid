(function ($) {
    ...
    var ajaxurl = masonry_grid_admin.ajax_url;
    var MasonryGridNonce = masonry_grid_admin.ajax_nonce;

    // Category Color
    $('#masonry-grid-cat-color').wpColorPicker();
    ...
    $('.twp-img-upload-button').click( function(){
        ...
        frame = wp.media({
            title: masonry_grid_admin.upload_image,
            button: {
            text: masonry_grid_admin.use_image
            },
    ...
    // Dismiss notice
    var masonryAjaxUrl = masonry_grid_admin.ajax_url;
    $('.twp-custom-setup').click(function(){
        jQuery.post(masonryAjaxUrl, {
            action: 'masonry_grid_notice_dismiss',
            security: MasonryGridNonce,
        });
        $('.twp-masonry-grid-notice').hide();
    ...
    $('.twp-install-active').click(function(){
        ...
        $(this).closest('.twp-masonry-grid-notice').addClass('twp-installing');

        var data = {
            'action': 'masonry_grid_install_plugins',
            '_wpnonce': MasonryGridNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            var active = masonry_grid_admin.active
            var deactivate = masonry_grid_admin.deactivate
